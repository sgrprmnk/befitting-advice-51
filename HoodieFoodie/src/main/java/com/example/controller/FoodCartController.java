...
public class FoodCartController {
    ...
    public ResponseEntity<FoodCart> saveFoodcart(@RequestBody FoodCart foodCart)throws FoodCartException{
        FoodCart fc=foodCartService.saveFoodcart(foodCart);
    ...
    @PutMapping("/IncreaseQuantity/{cart}/{quantity}")
    public ResponseEntity<FoodCart> increaseItemQuantity(@PathVariable("cart")String foodCart, @RequestBody Item item, @PathVariable("quantity") Integer quantity) throws FoodCartException {

        FoodCart fc = foodCartService.increaseQuantity(foodCart, item, quantity);
        return new ResponseEntity<>(fc, HttpStatus.ACCEPTED);
    }

    @PutMapping("/ReduceQuantity/{cart}/{quantity}")
    public ResponseEntity<FoodCart> ReduceItemQuantity(@PathVariable("cart")String foodCart, @RequestBody Item item, @PathVariable("quantity") Integer quantity) throws FoodCartException {
